...
.controller('TempMainCtrl', ['$scope', '$stateParams' ,'$ionicModal', 'RoutineService', '$ionicPopup', '$cordovaCamera', 'BlueThermService', '$ionicSlideBoxDelegate', '$timeout', '$ionicLoading','$ionicPopover','$rootScope',
function($scope, $stateParams ,$ionicModal, RoutineService, $ionicPopup, $cordovaCamera, BlueThermService, $ionicSlideBoxDelegate, $timeout, $ionicLoading,$ionicPopover,$rootScope) {
	...
	var isUseThermo = true;
  	...
  	var PRODUCT_DETAIL_TEMPLATE = 'app/routine/temp/temp-product-detail.html';
  	var PRODUCT_DETAIL_TEMPLATE2 = 'app/routine/temp/temp-product-detail2.html';
  	var PRODUCT_LIST_TEMPLATE = 'app/routine/temp/temp-product-list.html';
    var PRODUCT_RIBBON = 'app/routine/temp/temp-ribbon.html';
    ...
    $scope.deviceInfo = 'Your bluetooth thermometer is not connected. Click on the ' +
		'pencil icon below to enter Manual Temperature';
